...
export const todayResults = [
  { id: 'today-2', date: 'Apr 15, 2026', round: 'SEC Championship — R1', homeTeam: { name: 'Tennessee', rank: 56, record: '10-17', logo: '🍊', conference: 'SEC' }, awayTeam: findTeam('Ole Miss'), teamScore: { home: 0, away: 4 }, winner: 'away' },
  { id: 'today-4', date: 'Apr 15, 2026', round: 'ACC Championship — R1', homeTeam: { name: 'Boston College', rank: null, record: '', logo: '🦅', conference: 'ACC' }, awayTeam: { name: 'Duke', rank: 45, record: '13-12', logo: '😈', conference: 'ACC' }, teamScore: { home: 0, away: 4 }, winner: 'away' },
  { id: 'today-5', date: 'Apr 15, 2026', round: 'ACC Championship — R1', homeTeam: { name: 'Virginia Tech', rank: null, record: '', logo: '🦃', conference: 'ACC' }, awayTeam: { name: 'North Carolina', rank: 46, record: '13-10', logo: '🐏', conference: 'ACC' }, teamScore: { home: 0, away: 4 }, winner: 'away' },
  { id: 'today-6', date: 'Apr 15, 2026', round: 'ACC Championship — R1', homeTeam: { name: 'California', rank: 47, record: '14-12', logo: '🐻', conference: 'ACC' }, awayTeam: { name: 'Georgia Tech', rank: 57, record: '12-12', logo: '🐝', conference: 'ACC' }, teamScore: { home: 4, away: 0 }, winner: 'home' },
  { id: 'today-7', date: 'Apr 15, 2026', round: 'ACC Championship — R1', homeTeam: { name: 'Florida State', rank: 60, record: '12-14', logo: '🔶', conference: 'ACC' }, awayTeam: { name: 'Louisville', rank: 62, record: '17-12', logo: '🔴', conference: 'ACC' }, teamScore: { home: 4, away: 1 }, winner: 'home' },
